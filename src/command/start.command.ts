...
export class StartCommand extends Command {
  ...
  handle(): void {
    ...
    // Диагностика
    this.bot.hears('Диагностика', (ctx) => {
    ...
    // Индивидуальная программа
    this.bot.hears('Индивидуальная программа', (ctx) => {
    ...
    // Персональное ведение
    this.bot.hears('Персональное ведение', (ctx) => {
      const individualProgrannText =
    ...
    // Узнать стоимость
    this.bot.hears(['Узнать стоимость', 'Оставить заявку'], (ctx) => {
      const text =
    ...
    // Назад
    this.bot.hears('Назад в меню', (ctx) => {
      const caption =
        `Приветствую тебя, ${ctx.message.from.first_name}👋. \n` +
        'Меня зовут Анар 👨‍🎓 \n\n' +
        'Я сертифицированный фитнес тренер и фитнес блоггер, который натурально пришел к телу своей мечты и помогу сделать это тебе🫵\n\n' +
